...
const heroSauces = [
  ...
  { name: "Citrus Shoyu", tagline: "The Bright Side of Bold", image: nbCitrusShoyu, spice: 1, desc: "Yuzu-forward citrus over clean shoyu — tangy, bright, mild heat. The light sauce with serious edge." },
] as const;
