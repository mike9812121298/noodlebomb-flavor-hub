  ...
  <div className="min-h-screen bg-background pt-24 pb-20 md:pb-0">
    <div className="container py-16">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
        ...
        <p className="text-muted-foreground mt-1 text-sm">Free US shipping on orders $29.99+ — limited small-batch inventory.</p>
      </motion.div>
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="flex items-center gap-1.5 mb-6">
                  ...
                  <span className="text-xs text-foreground/60 font-display font-semibold uppercase tracking-wider">Free US shipping on orders $29.99+</span>
                </div>
                <Link
