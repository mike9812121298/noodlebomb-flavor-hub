        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="prose prose-invert max-w-none">
          ...
          <div className="bg-card rounded-2xl border border-border p-8 mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              NoodleBomb is what came out of that obsession. Each bottle is built around a different kind of craving — savory, spicy, or bright — and made to finish the food people actually eat: noodles, rice, wings, dumplings, eggs, vegetables, and leftovers. Ashley wants every bowl to feel intentional. Not like a shortcut. Not like a ramen sauce you pour on and forget. Like someone genuinely cared about what you were about to eat.
            </p>
          </div>
