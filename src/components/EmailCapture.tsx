        ...
        >
          ...
          {!submitted ? (
            <>
              ...
              <h3 className="font-display text-2xl font-bold text-foreground mb-2">Get 10% Off Your First Order</h3>
              <p className="text-sm text-muted-foreground mb-6">
                Join the NoodleBomb crew and we'll send your discount to your inbox.
              </p>
