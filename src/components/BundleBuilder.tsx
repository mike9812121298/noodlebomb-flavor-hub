          ...
          >
            ...
            {discount.pct > 0 && (
              <p className="text-sm font-display font-bold text-primary mt-1.5">
                🎉 You've unlocked {discount.label} off + free shipping at $29.99+!
              </p>
            )}
          </motion.div>
        )}
        ...
        {totalItems > 0 && (
          ...
          >
            ...
            <div className="flex items-center justify-center gap-1.5 mb-3">
              <span className="text-[10px] font-display uppercase tracking-wider text-muted-foreground">🚚 Free Shipping $29.99+</span>
            </div>
            <motion.a
