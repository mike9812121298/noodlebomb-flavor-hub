...
(function () {
  ...
  function ensureHomepagePatchStyles() {
    ...
    style.textContent = [
      ...
      '.hero-section .nb-live-trio-hero{position:absolute!important;left:auto!important;right:clamp(0px,4vw,72px)!important;top:50%!important;bottom:auto!important;width:min(52vw,860px)!important;height:86%!important;object-fit:contain!important;object-position:center!important;transform:translateY(-50%)!important;transition:none!important;filter:drop-shadow(0 30px 70px rgba(0,0,0,.62))!important;}',
      ...
      '@media (max-width:768px){.hero-section .nb-live-trio-hero{width:min(104vw,430px)!important;height:44%!important;right:-2vw!important;top:31%!important;opacity:.86!important;}#next-drop .nd-image-preorder{bottom:8px!important;font-size:10px!important;letter-spacing:.1em!important;padding:12px 14px!important;max-width:calc(100% - 18px)!important;}}'
    ].join('\n');
  ...
  function patchHomepageHero() {
    ...
    heroImg.src = '/uploads/noodlebomb-trio.png';
    heroImg.alt = 'NoodleBomb trio bottles on black background - Original, Spicy Tokyo, and Citrus Shoyu';
