...
const FLAVOR_IMAGES = {
  ...
  original: "uploads/nb-original-approved-front-v2-20260710-480.webp",

  spicy: "uploads/nb-spicy-approved-front-v3-20260710-480.webp",

  citrus: "uploads/nb-citrus-approved-front-v3-20260710-480.webp",

  shoyu: "uploads/nb-shoyu-reserve-front-approved-20260711-480.webp"
...
function FlavorBreakdown({ flavor }) {
  ...
  }), /* @__PURE__ */ React.createElement("div", { className: "fb-section-header", style: { position: "absolute", top: 100, left: 28, right: 28, display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: "var(--muted)" } }, "Flavor breakdown"), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: "var(--muted)" } }, "pour.02 / of.05")), /* @__PURE__ */ React.createElement("h2", { className: "display section-h2 fb-headline", style: {
...
function UseItOn() {
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "range-desktop", style: { height: `${panelCount * 100}vh`, background: active.bg, transition: "background 0.6s cubic-bezier(.2,.7,.2,1)", color: active.ink } }, /* @__PURE__ */ React.createElement("div", { style: { position: "sticky", top: 0, height: "100vh", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", top: 28, left: 28, right: 28, zIndex: 5, display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: active.sub, opacity: 1 } }, "Sauce range"), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: active.sub, opacity: 1 } }, String(Math.min(panelCount, Math.floor(progress * panelCount) + 1)).padStart(2, "0"), " / ", String(panelCount).padStart(2, "0"))), /* @__PURE__ */ React.createElement("div", { ref: track, style: {
...
function Origin() {
  ...
  const stats = [
    ...
    { num: "1", label: "Bonney Lake roots, Tacoma production" }
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1100, margin: "0 auto" } }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--muted)", marginBottom: 28, letterSpacing: "0.18em" } })), /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement(
    ...
    ), /* @__PURE__ */ React.createElement("figcaption", { style: { position: "absolute", left: 24, bottom: 16, fontFamily: "JetBrains Mono", fontSize: 10, letterSpacing: "0.18em", color: "rgba(245,241,234,0.85)", textTransform: "uppercase" } }, "Family-owned \u00b7 Bonney Lake, WA \u00b7 Goes on everything"))), /* @__PURE__ */ React.createElement(Reveal, { delay: 3 }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--muted)", fontSize: 10, letterSpacing: "0.14em" } }, "$3.00 flat US ship \u00b7 FREE on $29.99+")
...
function Testimonials() {
  ...
  const cfg = typeof window !== "undefined" ? window.NB_REVIEWS : null;

  const legacy = typeof window !== "undefined" && Array.isArray(window.NB_REAL_TESTIMONIALS) ? window.NB_REAL_TESTIMONIALS.map((q) => ({ quote: q == null ? void 0 : q.body, name: q == null ? void 0 : q.name, source: q == null ? void 0 : q.tag })) : [];

  const defaultSource = cfg && cfg.defaultSource ? cfg.defaultSource : "Verified Amazon review";

  const items = (cfg && Array.isArray(cfg.items) ? cfg.items : []).concat(legacy).filter((q) => q && q.quote && q.name);

  if (items.length < 3) return null;

  const stars = (n) => "\u2605".repeat(Math.max(1, Math.min(5, Math.round(Number(n) || 5))));

  const card = (q, i, dup) => /* @__PURE__ */ React.createElement("div", { key: `${dup ? "b" : "a"}${i}`, className: "nb-rev-card", "aria-hidden": dup ? "true" : void 0 }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-stars", "aria-label": dup ? void 0 : `${Math.max(1, Math.min(5, Math.round(Number(q.stars) || 5)))} out of 5 stars` }, stars(q.stars)), /* @__PURE__ */ React.createElement("div", { className: "nb-rev-quote" }, "\u201C", q.quote, "\u201D"), /* @__PURE__ */ React.createElement("div", { className: "nb-rev-meta" }, /* @__PURE__ */ React.createElement("span", { className: "nb-rev-name" }, "\u2014 ", q.name, q.product ? ` \u00b7 ${q.product}` : ""), /* @__PURE__ */ React.createElement("span", { className: "nb-rev-chip" }, q.source || defaultSource)));

  const duration = Math.max(36, items.length * 9);

  const group = (dup) => /* @__PURE__ */ React.createElement("div", { className: "nb-rev-group" }, items.map((q, i) => card(q, i, dup)));

  return /* @__PURE__ */ React.createElement("section", { id: "reviews", className: "nb-rev-section", "aria-labelledby": "reviews-heading" }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-head" }, /* @__PURE__ */ React.createElement("h2", { id: "reviews-heading", className: "display", style: { margin: 0 } }, "What customers say"), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: "var(--muted)" } }, "From Amazon listings")), /* @__PURE__ */ React.createElement("div", { className: "nb-rev-marquee" }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-track", style: { animationDuration: `${duration}s` } }, group(false), group(true))));
...
function FlavorPicker({ flavor, setFlavor }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "lineup", style: { background: "var(--paper-2)", padding: "140px clamp(24px, 5.5vw, 80px)", scrollMarginTop: 80 } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1300, margin: "0 auto" } }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--muted)", marginBottom: 16 } }, "Sauce lineup")), /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("h2", { className: "display section-h2", style: { margin: "0 0 32px", maxWidth: 900 } }, "Three ramen sauces.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)" } }, "Pick one. Or all three."))), /* @__PURE__ */ React.createElement(Reveal, { delay: 2 }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    return /* @__PURE__ */ React.createElement(Reveal, { key: k, delay: i + 1 }, /* @__PURE__ */ React.createElement(
      ...
      ), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--ink-40)", fontSize: 9, letterSpacing: "0.14em", marginTop: 10 } }, "$3.00 flat US ship \u00b7 FREE on $29.99+"), /* @__PURE__ */ React.createElement(
...
function FinalCTA() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { id: "cta", style: { background: "var(--accent)", color: "var(--accent-ink)", transition: "background .6s, color .6s", padding: "128px clamp(24px, 5.5vw, 80px) 96px", textAlign: "center", position: "relative", overflow: "hidden", scrollMarginTop: 80 } }, /* @__PURE__ */ React.createElement("div", { className: "ask-grain" }), /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", style: {
  ...
  ), /* @__PURE__ */ React.createElement("button", { type: "submit", style: { background: "transparent", color: "var(--accent-ink)", border: "none", padding: "14px 20px", fontWeight: 600, cursor: "pointer", fontFamily: "Inter", fontSize: 13, letterSpacing: "0.06em", textTransform: "uppercase", transition: "background .2s", width: "100%" }, onMouseOver: (e) => e.currentTarget.style.background = "rgba(245,241,234,0.08)", onMouseOut: (e) => e.currentTarget.style.background = "transparent" }, "Subscribe $29.99/mo \u2192")))), /* @__PURE__ */ React.createElement(Reveal, { delay: 4 }, /* @__PURE__ */ React.createElement("div", { className: "trust-line-wrap", style: { marginTop: 36, overflow: "hidden", maskImage: "linear-gradient(90deg, transparent 0%, #000 8%, #000 92%, transparent 100%)", WebkitMaskImage: "linear-gradient(90deg, transparent 0%, #000 8%, #000 92%, transparent 100%)" } }, /* @__PURE__ */ React.createElement("div", { className: "trust-line-track mono", style: { display: "inline-flex", whiteSpace: "nowrap", fontSize: 11, letterSpacing: "0.18em", opacity: 0.7, willChange: "transform" } }, Array.from({ length: 4 }).map((_, j) => /* @__PURE__ */ React.createElement("span", { key: j, style: { paddingRight: 32 } }, "PREMIUM INGREDIENTS \u00b7 TACOMA CO-PACKER \u00b7 FAMILY-OWNED IN WASHINGTON \u00b7 $3.00 FLAT US SHIPPING \u00b7 FREE ON $29.99+ \u00b7")))))), /* @__PURE__ */ React.createElement("div", { className: "finalcta-corner finalcta-corner-left", style: { position: "absolute", bottom: 24, left: 28, zIndex: 1 } }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { opacity: 0.65 } }, "family-owned \u00b7 made in the USA")), /* @__PURE__ */ React.createElement("div", { className: "finalcta-corner finalcta-corner-right", style: { position: "absolute", bottom: 24, right: 28, zIndex: 1 } }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { opacity: 0.65 } }, "pacific northwest \u00b7 est. 2024"))), /* @__PURE__ */ React.createElement("div", { className: "marq-wrap", style: { padding: "32px 0", background: "#080706", color: "var(--ink)", overflow: "hidden", borderTop: "1px solid var(--line)", borderBottom: "1px solid var(--line)", transform: "skewY(-2deg)", margin: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "marq-track" }, Array.from({ length: 2 }).map(

    (_, j) => /* @__PURE__ */ React.createElement(React.Fragment, { key: j }, ["SMALL BATCH", "\u2022", "PREMIUM INGREDIENTS", "\u2022", "SLOW-BREWED FOR DEPTH", "\u2022", "POUR IT ON EVERYTHING", "\u2022", "FAMILY-OWNED IN BONNEY LAKE WA", "\u2022"].map(

      (s, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: "display", style: { fontSize: 96, letterSpacing: "-0.05em", color: "var(--ink)", opacity: 0.48 } }, s)

    ))

  ))), /* @__PURE__ */ React.createElement("footer", { style: { background: "#080706", color: "var(--ink)", padding: "80px 28px 40px" } }, /* @__PURE__ */ React.createElement("div", { className: "footer-newsletter", style: { maxWidth: 1440, margin: "0 auto 48px", display: "grid", gridTemplateColumns: "minmax(0, 1.2fr) minmax(0, 1fr)", gap: 48, alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "display", style: { fontSize: "clamp(28px, 3vw, 40px)", letterSpacing: "-0.03em", lineHeight: 1.05, fontWeight: 600 } }, "Sauce drops, restock alerts, the occasional recipe."), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Inter", fontSize: 14, color: "var(--ink-60)", marginTop: 10 } }, "Once a month. Never spam.")), /* @__PURE__ */ React.createElement("form", { className: "footer-newsletter-form", "data-lead-form": "newsletter", action: "https://formsubmit.co/hello@noodlebomb.co", method: "POST", style: { display: "flex", gap: 0, border: "1px solid var(--line)", borderRadius: 4, overflow: "hidden", background: "#100E0C" } }, /* @__PURE__ */ React.createElement("input", { type: "hidden", name: "_subject", value: "NoodleBomb Newsletter Signup" }), /* @__PURE__ */ React.createElement("input", { type: "hidden", name: "_template", value: "table" }), /* @__PURE__ */ React.createElement(
...

    {
      ...
      href: "https://instagram.com/noodlebombsauce",
...

    {
      ...
      href: "https://tiktok.com/@noodlebombsauce",
...
function Tweaks({ state, set, open, setOpen }) {
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "row" }, /* @__PURE__ */ React.createElement("span", null, "Grain texture"), /* @__PURE__ */ React.createElement("div", { className: `toggle ${state.grain ? "on" : ""}`, onClick: () => set({ grain: !state.grain }) })), /* @__PURE__ */ React.createElement("div", { className: "row", style: { display: "block" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 6 } }, "Headline"), /* @__PURE__ */ React.createElement("input", { type: "text", value: state.headline, onChange: (e) => set({ headline: e.target.value }) }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--muted)", marginTop: 4 } }, "use \\n for line break")));
...
const NBG_FLAVORS = [
  ...
  { name: "Spicy Shoyu", tag: "Spicy Reserve", color: "--nbg-chili", img: "/uploads/nb-shoyu-spicy-front-approved-20260711-480.webp", weight: 1 },

  { name: "Fire Dust", tag: "Korean Chili Crunch", color: "--nbg-chili", img: "/uploads/nb-fire-dust-approved-front-20260710-normalized.webp", weight: 1 },

  { name: "Roasted Garlic Sesame", tag: "Garlic Sesame Crunch", color: "--nbg-gold", img: "/uploads/nb-rgs-approved-front-20260710-normalized.webp", weight: 1 },

  { name: "The Trio", tag: "One of each", color: "--nbg-cream", img: "/uploads/nb-trio-approved-20260711-640.webp", weight: 2 }
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("style", null, `
        ...
        .nbg-live-photo {
          ...
          background: image-set(url("/uploads/nb-trio-approved-20260711-960.webp") 1x, url("/uploads/nb-trio-approved-20260711.webp") 2x) right center / cover no-repeat;
    ...
    /* @__PURE__ */ React.createElement("div", { className: "nbg-grid" }, /* @__PURE__ */ React.createElement("div", { className: "nbg-live-copy" }, /* @__PURE__ */ React.createElement("div", { className: "nbg-eyebrow" }, /* @__PURE__ */ React.createElement("span", { className: "nbg-live-dot" }), "LIVE VIEW \u2014 ORDERS ACROSS THE U.S."), /* @__PURE__ */ React.createElement("h2", { id: "order-map-heading", className: "nbg-h" }, "Get Your City ", /* @__PURE__ */ React.createElement("span", { className: "nbg-hl-gold" }, "on the Map")), /* @__PURE__ */ React.createElement("p", { className: "nbg-sub" }, "Every pin marks a NoodleBomb order moving from Washington to a hungry bowl somewhere. Drag the globe. Watch it light up."), /* @__PURE__ */ React.createElement("div", { className: "nbg-flavors" }, /* @__PURE__ */ React.createElement("span", { className: "nbg-flavors-lab" }, "The lineup"), NBG_FLAVORS.filter((f) => f.name !== "The Trio").map((f) => /* @__PURE__ */ React.createElement("span", { className: "nbg-flavor-chip", key: f.name }, /* @__PURE__ */ React.createElement("span", { className: "nbg-fc-dot", style: { background: nbgColor(f.color) } }), f.name))), /* @__PURE__ */ React.createElement("div", { className: "nbg-stats" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "nbg-stat-num" }, /* @__PURE__ */ React.createElement(BombCount, { value: citiesReached })), /* @__PURE__ */ React.createElement("div", { className: "nbg-stat-lab" }, "Cities Lit Up")), /* @__PURE__ */ React.createElement("div", { className: "nbg-stat-div" }), /* @__PURE__ */ React.createElement("div", { className: "nbg-reach" }, /* @__PURE__ */ React.createElement("span", { className: "nbg-reach-line" }, /* @__PURE__ */ React.createElement("b", null, /* @__PURE__ */ React.createElement(BombCount, { value: statesCount })), " ", statesCount === 1 ? "state" : "states"), /* @__PURE__ */ React.createElement("span", { className: "nbg-reach-dot" }, "\u00b7"), /* @__PURE__ */ React.createElement("span", { className: "nbg-reach-line" }, /* @__PURE__ */ React.createElement("b", null, /* @__PURE__ */ React.createElement(BombCount, { value: countries })), " ", countries === 1 ? "country" : "countries"))), /* @__PURE__ */ React.createElement("div", { className: "nbg-seg", role: "tablist", "aria-label": "Map layer" }, /* @__PURE__ */ React.createElement("span", { className: "nbg-seg-thumb", role: "presentation" }), /* @__PURE__ */ React.createElement("button", { type: "button", role: "tab", "aria-selected": mode === "orders", className: "nbg-seg-btn " + (mode === "orders" ? "on" : ""), onClick: () => setMode("orders") }, "Orders"), /* @__PURE__ */ React.createElement("button", { type: "button", role: "tab", "aria-selected": mode === "stores", className: "nbg-seg-btn " + (mode === "stores" ? "on" : ""), onClick: () => setMode("stores") }, "Find in stores")), /* @__PURE__ */ React.createElement("div", { className: "nbg-legend" }, mode === "orders" ? /* @__PURE__ */ React.createElement("span", { className: "nbg-lg" }, /* @__PURE__ */ React.createElement("span", { className: "nbg-lg-dot home" }), " Ships from Bonney Lake, WA ", /* @__PURE__ */ React.createElement("span", { className: "nbg-lg-dot order" }), " live orders") : /* @__PURE__ */ React.createElement("span", { className: "nbg-lg" }, /* @__PURE__ */ React.createElement("span", { className: "nbg-lg-dot store" }), " ", storesCount > 0 ? `${storesCount} ${storesCount === 1 ? "store stocks" : "stores stock"} NoodleBomb` : "Retail finder coming soon \u2014 shop online now")), mode === "stores" && storesCount > 0 && /* @__PURE__ */ React.createElement("div", { className: "nbg-stores" }, stores.map((s) => {
...
function StarterPath() {
  ...
  const cards = [
...

    {
      ...
      title: "Monthly Ramen Box",

      body: "Ramen Night Club is the vibe: a Monthly Ramen Box with sauce rotation, ramen-night ideas, and dinner help without thinking too hard.",
...
function BuildBundle() {
  ...
  const products = [
...

    {
      ...
      image: "uploads/nb-shoyu-spicy-front-approved-20260711-480.webp",
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "bundle-shell" }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "bundle-head" }, /* @__PURE__ */ React.createElement("div", { className: "mono bundle-kicker" }, "Build a Bundle"), /* @__PURE__ */ React.createElement("h2", { className: "display" }, "Build your set."), /* @__PURE__ */ React.createElement("p", null, "Tap + to add bottles. Any three get trio pricing \u2014 no matching flavors required."), /* @__PURE__ */ React.createElement("div", { className: "bundle-savings-banner" }, /* @__PURE__ */ React.createElement("strong", null, "Any 3 bottles = Trio pricing"), /* @__PURE__ */ React.createElement("span", null, "Mix flavors. Save automatically. $3.00 flat US ship \u00b7 FREE on $29.99+.")))), /* @__PURE__ */ React.createElement("div", { className: "bundle-arena" }, /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("div", { className: "bundle-product-grid", "aria-label": "Build a NoodleBomb bundle" }, products.map((product) => {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "bundle-note" }, "Any 3 bottles ship at the trio price. $3.00 flat US shipping \u2014 FREE on $29.99+ US orders. Express rates shown at checkout.")))))
...
function App() {
  ...
  useEffect(() => {
    ...
    timer = window.setTimeout(reveal, 6000);
