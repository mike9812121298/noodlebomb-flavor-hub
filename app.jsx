...
function Testimonials() {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "reviews", className: "nb-rev-section" }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-head" }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--muted)" } }, "Index 07 \u2014 What Customers Say")), /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: "var(--muted)" } }, "Real reviews \u00b7 verbatim"))), /* @__PURE__ */ React.createElement("div", { className: "nb-rev-marquee" }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-track", style: { animationDuration: `${duration}s` } }, group(false), group(true))));
...
function FinalCTA() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { id: "cta", style: { background: "var(--accent)", color: "var(--accent-ink)", transition: "background .6s, color .6s", padding: "128px clamp(24px, 5.5vw, 80px) 96px", textAlign: "center", position: "relative", overflow: "hidden", scrollMarginTop: 80 } }, /* @__PURE__ */ React.createElement("div", { className: "ask-grain" }), /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", style: {
    ...
    ["Shop", [["Original", WIX_URLS.original], ["Spicy Tokyo", WIX_URLS.spicy], ["Citrus Shoyu", WIX_URLS.citrus], ["The NoodleBomb Trio", WIX_URLS.trio], ["Shoyu Reserve", WIX_URLS.shoyu], ["Ramen Night Club", "#monthly"]]],

    ["Learn", [["Recipes", "/recipes"], ["Ingredients", "#ingredients"], ["The Range", "#range"], ["The Pour", "#pour"], ["Ramen Night Club", "#monthly"]]],
...
function StarterPath() {
  ...
  const cards = [
...

    {
      ...
      body: "Use Ramen Night Club as the easy repeat option: ramen-night ideas, sauce rotation, and dinner help without thinking too hard.",
