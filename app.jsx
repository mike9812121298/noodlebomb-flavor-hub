...
// The live Shopify Trio is a fixed Original + Spicy Tokyo + Citrus Shoyu SKU.
// Keep the old arbitrary-mix builder dormant until fulfillment supports it.
const CUSTOM_BUNDLE_ENABLED = false;
...
const SOY_SAUCES = [
  ...
  { slug: "shoyu", name: "Shoyu Reserve", tag: "Reserve \u00b7 Soy Sauce", color: "#D7A84D", rgb: "215, 168, 77", line1: "Slow-brewed shoyu depth.", line2: "Bold, clean finish.", price: "$13.99", image: "uploads/nb-shoyu-reserve-front-cutout-2026-06-09.webp", detail: "/shoyu-reserve" },

  { slug: "shoyuspicy", name: "Spicy Shoyu", tag: "Reserve \u00b7 Spicy Soy", color: "#B2221A", rgb: "178, 34, 25", line1: "The reserve bottle, turned up.", line2: "Slow-brewed depth with real heat.", price: "$13.99", image: "uploads/nb-shoyu-spicy-front-cutout-2026-06-09.webp", detail: "/spicy-shoyu-ramen-sauce" }
...
function FlavorPicker({ flavor, setFlavor }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "lineup", style: { background: "var(--paper-2)", padding: "140px clamp(24px, 5.5vw, 80px)", scrollMarginTop: 80 } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1300, margin: "0 auto" } }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--muted)", marginBottom: 16 } }, "Sauce lineup")), /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("h2", { className: "display section-h2", style: { margin: "0 0 32px", maxWidth: 900 } }, "Three ramen sauces.", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)" } }, "Pick one. Or all three."))), /* @__PURE__ */ React.createElement(Reveal, { delay: 2 }, /* @__PURE__ */ React.createElement("div", { style: {
    ...
    return /* @__PURE__ */ React.createElement(Reveal, { key: k, delay: i + 1 }, /* @__PURE__ */ React.createElement(
      ...
      ), /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--ink-40)", fontSize: 9, letterSpacing: "0.14em", marginTop: 10 } }, "$3.50 flat US ship \u00b7 FREE on $29.99+"), /* @__PURE__ */ React.createElement(
...
function BuildBundle() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "bundle-shell" }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "bundle-head" }, /* @__PURE__ */ React.createElement("div", { className: "mono bundle-kicker" }, "Build a Bundle"), /* @__PURE__ */ React.createElement("h2", { className: "display" }, "Build your set."), /* @__PURE__ */ React.createElement("p", null, "Tap + to add bottles. Any three get trio pricing \u2014 no matching flavors required."), /* @__PURE__ */ React.createElement("div", { className: "bundle-savings-banner" }, /* @__PURE__ */ React.createElement("strong", null, "Any 3 bottles = Trio pricing"), /* @__PURE__ */ React.createElement("span", null, "Mix flavors. Save automatically. $3.50 flat US ship \u00b7 FREE on $29.99+.")))), /* @__PURE__ */ React.createElement("div", { className: "bundle-arena" }, /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("div", { className: "bundle-product-grid", "aria-label": "Build a NoodleBomb bundle" }, products.map((product) => {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "bundle-note" }, "Any 3 bottles ship at the trio price. $3.50 flat US shipping \u2014 FREE on $29.99+ US orders. Priority $12 at checkout.")))))
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(StickyCartBar, { flavor: state.flavor, flavors: FLAVORS }), /* @__PURE__ */ React.createElement(Nav, { flavor: state.flavor, setFlavor: (k) => set({ flavor: k }), flavors: FLAVORS }), /* @__PURE__ */ React.createElement(MobileAppDock, { flavor: state.flavor, flavors: FLAVORS }), /* @__PURE__ */ React.createElement(Hero, { headline, bottleSrc: FLAVOR_IMAGES[state.flavor], flavorKey: state.flavor, flavorMeta: FLAVORS[state.flavor] }), /* @__PURE__ */ React.createElement(TrustStrip, null), /* @__PURE__ */ React.createElement(StarterPath, null), /* @__PURE__ */ React.createElement(FlavorBreakdownV2, { flavor: state.flavor, setFlavor: (k) => set({ flavor: k }) }), CUSTOM_BUNDLE_ENABLED && /* @__PURE__ */ React.createElement(BuildBundle, null), showDeferredHome && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(OrderMapSection, null), /* @__PURE__ */ React.createElement(MonthlyDrop, null), /* @__PURE__ */ React.createElement(FlavorPicker, { flavor: state.flavor, setFlavor: (k) => set({ flavor: k }) }), /* @__PURE__ */ React.createElement(UseItOn, null), /* @__PURE__ */ React.createElement(FAQ, null), /* @__PURE__ */ React.createElement(FinalCTA, null)), IS_DEV_MODE && /* @__PURE__ */ React.createElement(Tweaks, { state, set, open: tweaksOpen, setOpen: setTweaksOpen }), /* @__PURE__ */ React.createElement(InquiryModal, { open: !!inquiry, kind: inquiry, onClose: () => setInquiry(null) }));
