        ...
        <div style={{ marginTop: 72 }}>
          ...
          <Reveal delay={2}>
            <p style={{ color: 'var(--ink-60)', fontFamily: 'Inter', fontSize: 14, maxWidth: '52ch', margin: '0 0 28px', lineHeight: 1.55 }}>
              The reserve line — bold soy sauce for bowls, rice, eggs, dumplings, and marinades. Classic or spicy.
            </p>
          </Reveal>
              ...
              <div className="trust-line-track mono" style={{ display: 'inline-flex', whiteSpace: 'nowrap', fontSize: 11, letterSpacing: '0.18em', opacity: 0.7, willChange: 'transform' }}>
                {Array.from({ length: 4 }).map((_, j) => (
                  <span key={j} style={{ paddingRight: 32 }}>
                    BOLD FLAVOR · SMALL BATCH · MADE IN BONNEY LAKE, WA · FREE US SHIPPING $29.99+ ·
                  </span>
                ))}
              </div>
            </div>
        ...
        <div className="bundle-arena">
          ...
          <Reveal delay={2}>
            <div className="bundle-console" aria-live="polite">
              ...
              <div className="bundle-note">Every complete Original + Spicy Tokyo + Citrus Shoyu set is added as a discounted Trio. Shoyu Reserve is a paid add-on item.</div>
