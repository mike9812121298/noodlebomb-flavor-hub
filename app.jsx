...
function Testimonials() {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: "reviews", className: "nb-rev-section" }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-head" }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--muted)" } }, "Customer notes")), /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("span", { className: "mono", style: { color: "var(--muted)" } }, "Flavor notes"))), /* @__PURE__ */ React.createElement("div", { className: "nb-rev-marquee" }, /* @__PURE__ */ React.createElement("div", { className: "nb-rev-track", style: { animationDuration: `${duration}s` } }, group(false), group(true))));
