...
function BuildBundle() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "bundle-shell" }, /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "bundle-head" }, /* @__PURE__ */ React.createElement("div", { className: "mono bundle-kicker" }, "Build a Bundle"), /* @__PURE__ */ React.createElement("h2", { className: "display" }, "Power up your cart."), /* @__PURE__ */ React.createElement("p", null, "Tap + to stack bottles like a loadout. Any 3 bottles unlock Trio savings, no matching flavors required, and every bottle pushes the power meter higher."), /* @__PURE__ */ React.createElement("div", { className: "bundle-savings-banner" }, /* @__PURE__ */ React.createElement("strong", null, "Any 3 bottles = Trio pricing"), /* @__PURE__ */ React.createElement("span", null, "Mix flavors. Save automatically. $3.50 flat US ship \u00b7 FREE on $29.99+.")))), /* @__PURE__ */ React.createElement("div", { className: "bundle-arena" }, /* @__PURE__ */ React.createElement(Reveal, { delay: 1 }, /* @__PURE__ */ React.createElement("div", { className: "bundle-product-grid", "aria-label": "Build a NoodleBomb bundle" }, products.map((product) => {
      const qty = quantities[product.slug];
