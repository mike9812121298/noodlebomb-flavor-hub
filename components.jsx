...
function Nav({ flavor, setFlavor, flavors }) {
  ...
  return /* @__PURE__ */ React.createElement("nav", { className: `nav ${solid ? "scrolled" : ""}`, style: {
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "JetBrains Mono", fontSize: 9, letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--accent)", fontWeight: 700, marginBottom: 2 } }, "Complete the set"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Inter Tight", fontWeight: 600, fontSize: 13, color: "var(--ink)" } }, NB_FIRE_DUST.label, " \xB7 ", fmtUSD(NB_FIRE_DUST.price)), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Inter", fontSize: 11, color: "var(--ink-60)", marginTop: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, NB_FIRE_DUST.tag)), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
