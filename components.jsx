...
const NB_FIRE_DUST = { slug: 'firedust', name: 'NoodleBomb Fire Dust', label: 'Fire Dust', price: 10.99, tag: 'Korean chili crunch - 3.2 oz topper', image: 'uploads/nb-fire-dust-approved-front-20260710-normalized-thumb.webp' };
