...
// Keep the first-box subscription out of the cart decision path while the
// fixed Trio and a Shake add-on are the measured basket offers.
const CART_BOWL_CLUB_UPSELL_ENABLED = false;
const RITUAL_KIT = {
  name: "Trio + Fire Dust",
  tag: "Original + Spicy Tokyo + Citrus Shoyu, plus one Fire Dust Shake",
  components: [
...
function RitualKitCard({ items, variant }) {
  ...
  const cta = missing.length === RITUAL_KIT.components.length ? "Add Trio + Fire Dust" : "Complete the set";
...
function CartPage() {
  ...
  const showBowlClubUpsell = CART_BOWL_CLUB_UPSELL_ENABLED && !!singleBottleItem && oneBottleUpsellSlugs.includes(singleBottleItem.slug) && Number(singleBottleItem.qty) === 1 && !hasTrioInCart;
  ...
  const showFireDustUpsell = !hasFireDustInCart;
  if (itemCount === 0) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("a", { className: "crumb", href: "/#lineup" }, "\u2190 Continue shopping"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 12, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("h1", { className: "page-title" }, "Your ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)", fontFamily: "Inter Tight", fontStyle: "normal", fontWeight: 800 } }, "cart."))), /* @__PURE__ */ React.createElement("p", { className: "page-meta" }, itemCount, " ", itemCount === 1 ? "item" : "items", " \xB7 secure checkout opens on Shopify"), /* @__PURE__ */ React.createElement("div", { className: "layout" }, /* @__PURE__ */ React.createElement("div", null, freeShipping ? /* @__PURE__ */ React.createElement("div", { className: "card ship-bar unlocked" }, /* @__PURE__ */ React.createElement("div", { className: "icon" }, /* @__PURE__ */ React.createElement(Truck, null)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Inter Tight", fontWeight: 700, fontSize: 14, color: "var(--ink)" } }, "\u2713 Free US shipping included"), /* @__PURE__ */ React.createElement("div", { style: { color: "var(--ink-40)", fontSize: 12, marginTop: 2 } }, "Your cart crossed the $29.99 free-shipping line."))) : /* @__PURE__ */ React.createElement("div", { className: "card ship-bar" }, /* @__PURE__ */ React.createElement("div", { className: "row" }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--ink-60)" } }, "Add ", /* @__PURE__ */ React.createElement("span", { className: "accent" }, fmtUSD(remaining)), " for ", /* @__PURE__ */ React.createElement("span", { style: { color: "var(--ink)" } }, "FREE US shipping"), " \xB7 else $3.50 flat"), /* @__PURE__ */ React.createElement(Truck, null)), /* @__PURE__ */ React.createElement("div", { className: "track" }, /* @__PURE__ */ React.createElement("div", { className: "fill", style: { width: progress + "%" } }))), showBowlClubUpsell && /* @__PURE__ */ React.createElement(BowlClubUpsell, { item: singleBottleItem }), (() => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "card cart-trio-upsell", style: {
      border: "1px solid var(--accent)",
    ...
    )), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "mono", style: { color: "var(--accent)", fontSize: 10, letterSpacing: "0.18em", fontWeight: 700, marginBottom: 4 } }, "CART SLOT 1: TRIO"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Inter Tight", fontWeight: 700, fontSize: 16, color: "var(--ink)", marginBottom: 4 } }, "Swap to the fixed Trio"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "Inter", fontSize: 12, color: "var(--ink-60)", lineHeight: 1.5 } }, "Original + Spicy Tokyo + Citrus Shoyu for $34.99.")), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: swapToTrio,
