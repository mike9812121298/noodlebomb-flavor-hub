...
function CartPage() {
  ...
  if (itemCount === 0) {
    ...
    ), /* @__PURE__ */ React.createElement("a", { className: "btn btn-secondary", href: "/#lineup", style: { width: "auto", display: "inline-flex", padding: "14px 32px" } }, "Shop the lineup \u2192")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, fontSize: 11, color: "var(--ink-40)", fontFamily: "JetBrains Mono", letterSpacing: "0.16em", textTransform: "uppercase" } }, "All 3 flavors \xB7 save $3.98"), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 520, margin: "28px auto 0" } }, /* @__PURE__ */ React.createElement(RitualKitCard, { items, variant: "feature" })), /* @__PURE__ */ React.createElement("div", { className: "recommendations" }, RECS.map((r) => /* @__PURE__ */ React.createElement("a", { key: r.slug, className: "rec-card", href: "/?flavor=" + r.slug + "#lineup" }, /* @__PURE__ */ React.createElement("div", { className: "img-wrap" }, /* @__PURE__ */ React.createElement("img", { src: PRODUCT_IMAGES[r.slug], alt: "NoodleBomb " + r.name + " ramen sauce" })), /* @__PURE__ */ React.createElement("h3", null, r.name), /* @__PURE__ */ React.createElement("div", { className: "tag" }, r.tag), /* @__PURE__ */ React.createElement("div", { className: "price-row" }, /* @__PURE__ */ React.createElement("span", { className: "price" }, fmtUSD(r.price)), /* @__PURE__ */ React.createElement("span", { className: "arrow" }, "View \u2192"))))));
  }
